...
# Title
# -----------------------------
st.title("College Placement Prediction using Logistic Regression")
...
IQ = st.number_input("IQ", min_value=0)

CGPA = st.number_input("CGPA", min_value=0.0)

Academic_Performance = st.number_input("Academic Performance", min_value=0.0)

Communication_Skills = st.number_input("Communication Skills", min_value=0)
...
Projects_Completed = st.number_input("Projects Completed", min_value=0)
